<!DOCTYPE html>
<html lang="en">
<title>Add New Vehicle & Company</title>
  <!-- Add Bootstrap Links -->
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
 ...
 <div class="w3-container" id="showcase">
  ...
  <h3 class="w3-xxlarge w3-text-black"><b>Add New Vehicle & Company</b></h3>
    <hr style="width:530px;border:5px solid gold" class="w3-round">
	<br>
  
<div class="vertical-align"> 
<br>
<form action="addvehicle.php" method="post">
<input type="text" name="vehicle"><input class="btn btn-success" type="submit" value="Add Vehicle">
</form>
<br>
<form action="addcompany.php" method="post">
<input type="text" name="company"><input class="btn btn-success" type="submit" value="Add Company">
</form>
</div>
<!-- W3.CSS Container -->
