<!DOCTYPE html>
<html lang="en">
<title>Balance Amount Updation</title>
  <!-- Add Bootstrap Links -->
...
<nav class="w3-sidebar w3-green w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a href="#" onclick="window.location.href='index.php'" class="w3-bar-item w3-button  w3-hover-white">Home</a> 
    ...
    <a href="#contact" onclick="window.location.href='add1.php'"class="w3-bar-item w3-button  w3-hover-white">Add Vehicle & Company</a>
  </div>
</nav>
...
$sqli = "SELECT* FROM company WHERE company='".$a."'";
$resulti = mysqli_query($conn, $sqli);
$rowi = mysqli_fetch_assoc($resulti);

    
		$q1="UPDATE `company` SET `balance`='".$b."' WHERE company='".$a."'";
		mysqli_query($conn,$q1);
		mysqli_close($conn);
?>
<div class="vertical-align"> 
<center><table><tr><td><h3>The balance has been updated succesfully..!</h3></td></tr></table><center>
<div>
