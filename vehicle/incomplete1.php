<!DOCTYPE html>
<html lang="en">
<title>Shipment Info Updated</title>
  <!-- Add Bootstrap Links -->
...
$q1="UPDATE `main` SET `date`='".$a."',`vehicle`='".$b."',`company`='".$c."',`too`='".$d."',`material`='".$e."',`weight`='".$f."',`freight`=".$g.",`loading`=".$h.",`weighment`=".$i.",`unloading`=".$j.",`store`=".$k.",`other`=".$l.",`total`=".$m.",`advance`=".$n.",`balance`=".$o.",`remark`='".$p."',`advancetype`='".$q."',`mamul`=".$r.",`commision`=".$s.",`cashmode`='".$t."',`status`='incomplete',`bill`='".$w."' WHERE sno=".$z;
mysqli_query($conn,$q1);
mysqli_close($conn);
?>
<div class="vertical-align"> 
<center><table><tr><td><h3>The Shipment Info have been updated succesfully.</h3></td></tr></table><center>
<div>
