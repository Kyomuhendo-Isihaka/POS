<!DOCTYPE html>
<html lang="en">
<title>Shipment Info Added</title>
  <!-- Add Bootstrap Links -->
...
$q1="insert into main (`date`, `vehicle`, `company`, `invoice`, `too`, `material`, `weight`, `freight`, `loading`, `weighment`, `unloading`, `store`, `other`, `total`, `advance`, `balance`, `remark`, `advancetype`, `mamul`, `commision`, `cashmode`, `status`,`bill`) values('".$a."','".$b."','".$c."','".$v."','".$d."','".$e."','".$f."','".$g."','".$h."','".$i."','".$j."','".$k."','".$l."','".$m."','".$n."','".$o."','".$p."','".$q."','".$r."','".$s."','".$t."','".$u."','".$w."')";
...
<center><table><tr><td><h3>The Shipment Info have been added succesfully.</h3></td></tr></table><center>
<div>
