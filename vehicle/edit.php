...
<nav class="w3-sidebar w3-green w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a href="#" onclick="window.location.href='index.php'" class="w3-bar-item w3-button  w3-hover-white">Home</a> 
    ...
    <a href="#services" onclick="window.location.href='edit.php'"class="w3-bar-item w3-button w3-white w3-border w3-hover-white">Update Shipment Info</a> 
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
 ...
 <br>
  ...
  <h3 class="w3-xxlarge w3-text-black"><b>Update Shipment Info</b></h3>
    <hr style="width:390px;border:5px solid orange" class="w3-round">
	<br>
  <?php
$conn=mysqli_connect("localhost","root","","vehicle_db");
    ...
    $resulti = mysqli_query($conn, $sqli);
	  ...
	  echo "<table class='table' style='width:950px'>";
    echo "<thead>";
...
<tr><td></td><td>Enter the Serial No: </td><td><input type="text" name="sno"></td><td><input class="btn btn-success" type="submit" value="Click to continue"></td>
...
<!-- W3.CSS Container -->
<div class="w3-light-grey w3-container w3-padding-100" style="margin-top:75px;padding-right:58px"><p class="w3-right"><a href="https://www.w3schools.com/w3css/default.asp" title="W3.CSS" target="_blank" class="w3-hover-opacity"></a></p></div>
<script>
