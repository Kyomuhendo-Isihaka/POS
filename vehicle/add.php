...
<nav class="w3-sidebar w3-green w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <a href="#" onclick="window.location.href='index.php'" class="w3-bar-item w3-button  w3-hover-white">Home</a> 
    <a href="#showcase" onclick="window.location.href='add.php'"class="w3-bar-item w3-button w3-white w3-border  w3-hover-white">Register New Cargo</a> 
...
<form action="verify.php" method="post">
  <h3 class="w3-xxlarge w3-text-black"><b>Register New Cargo</b></h3>
  <hr style="width:350px;border:5px solid darkmagenta" class="w3-round">
  <br>
  <br>
