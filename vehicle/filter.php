...
$conn=mysqli_connect("localhost","root","","vehicle_db");
	$sqli = "SELECT date,vehicle,company,invoice,too,material,weight,freight,loading,weighment,unloading,store,other,total,advance,balance FROM main WHERE company='".$a."' and date BETWEEN '".$from."' AND '".$to."' ";
    $resulti = mysqli_query($conn, $sqli);
	echo "<center>";
echo '<div class="container" align="left" style="overflow:auto;">';
 echo " <h1 align='center'>Track the Shipments</h1>";
  echo "<table class='table'>";
   ...
   while($rowi = mysqli_fetch_assoc($resulti)) {			
	  echo "<tr >";
	  echo "<td>".$rowi['date']."</td><td>" . $rowi['vehicle']. "</td><td> " . $rowi['company']. "</td><td> " . $rowi['invoice']. "</td><td>" . $rowi['too']. "</td><td>" . $rowi['material']. "</td><td>" . $rowi['weight']. "</td><td>" . $rowi['freight']. "</td><td>" . $rowi['loading']. "</td><td>" . $rowi['weighment']. "</td><td>" . $rowi['unloading']. "</td><td>" . $rowi['store']. "</td><td>" . $rowi['other']. "</td><td>" . $rowi['total']. "</td><td>" . $rowi['advance']. "</td><td>" . $rowi['balance']. "</td>";
      echo "</tr>";
